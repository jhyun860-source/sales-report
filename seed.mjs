...
const BRANCHES = [
  ...
  { name: '문정1호점', code: 'munjeong1' },
  { name: '문정2호점', code: 'munjeong2' },
];

const ACCOUNTS = [
  { loginId: 's1', password: '1234', displayName: '선릉점 매니저', branchCode: 'seolleung', role: 'user' },
  { loginId: 's3', password: '1234', displayName: '선릉점 직원', branchCode: 'seolleung', role: 'user' },
  { loginId: 's2', password: '1234', displayName: '삼성점 매니저', branchCode: 'samsung', role: 'user' },
  { loginId: 's4', password: '1234', displayName: '삼성점 직원', branchCode: 'samsung', role: 'user' },
  { loginId: 'd1', password: '1234', displayName: '대치점 매니저', branchCode: 'daechi', role: 'user' },
  { loginId: 'd2', password: '1234', displayName: '대치점 직원', branchCode: 'daechi', role: 'user' },
  { loginId: 'm1', password: '1234', displayName: '문정1호점 매니저', branchCode: 'munjeong1', role: 'user' },
  { loginId: 'm3', password: '1234', displayName: '문정1호점 직원', branchCode: 'munjeong1', role: 'user' },
  { loginId: 'm2', password: '1234', displayName: '문정2호점 매니저', branchCode: 'munjeong2', role: 'user' },
...
async function seed() {
  ...
  console.log('─────────────────────────────────────');
  console.log('선릉점      | s1/s3  | 1234');
  console.log('대치점      | d1/d2  | 1234');
  console.log('삼성점      | s2/s4  | 1234');
  console.log('문정1호점   | m1/m3  | 1234');
  console.log('문정2호점   | m2/m4  | 1234');
